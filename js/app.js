(() => {
    ...
    (() => {
        ...
        const progressCircle = document.querySelector(".slider-navigation__autoplay-progress span");
        function initSliders() {
            if (document.querySelector(".preview-slider__slider")) {
                new core(".preview-slider__slider", {
                    ...
                    navigation: {
                        prevEl: ".slider-navigation__btn-prev",
                        nextEl: ".slider-navigation__btn-next"
                    },
                    on: {
                        autoplayTimeLeft(s, time, progress, percentage) {
            ...
            if (document.querySelector(".gallery-slider__swiper")) {
                new core(".gallery-slider__swiper", {
                    ...
                    navigation: {
                        prevEl: ".gallery-slider__navigation-btn-prev",
                        nextEl: ".gallery-slider__navigation-btn-next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 1,
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            ...
            resizableSwiper("(max-width: 768px)", ".advantages__slider", {
                modules: [ Pagination ],
                loop: true,
                slidesPerView: "auto",
                pagination: {
...
***************************************************************************** */        var __assign = function() {
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            if (isMobile.any()) {
                ...
                const arrows = document.querySelectorAll(".menu__item-arrow");
                arrows.forEach(((item, i) => {
                    item.addEventListener("click", (e => {
                        closeMenu();
                        if (!item.classList.contains("menu__item-arrow--active")) closeArrow();
                        let subMenu = item.nextElementSibling;
                        let thisArrow = item;
                        thisArrow.classList.toggle("menu__item-arrow--active");
                        if (thisArrow.classList.contains("menu__item-arrow--active")) subMenu.classList.toggle("open");
                        if (subMenu.classList.contains("open")) subMenu.classList.add("open"); else subMenu.classList.remove("open");
                    }));
                }));
                body.addEventListener("click", (e => {
                    let target = e.target;
                    if (!target.closest(".menu__item-arrow")) {
                        closeMenu();
                        closeArrow();
                    }
                }));
        ...
        function closeMenu() {
            const menuAll = document.querySelectorAll(".menu-sub");
        ...
        function closeArrow() {
            const arrows = document.querySelectorAll(".menu__item-arrow");
            arrows.forEach((item => {
                item.classList.remove("menu__item-arrow--active");
            }));
        }
        window["FLS"] = true;
        isWebp();
